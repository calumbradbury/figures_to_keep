...
h = ax.hist2d(x_list,y_list,bins=([0.5,1.5,2.5,3.5,4.5],[0.075,0.125,0.175,0.225,0.275,0.325,0.375,0.425,0.475,0.525,0.575,0.625,0.675,0.725,0.775,0.825,0.875,0.925,0.975]))#,range=((1,4),(0.025,1)))
plt.yticks(y_ticks)
...
fig.savefig('../concavity-tectonics.png', bbox_inches='tight')
